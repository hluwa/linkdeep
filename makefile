...
dist: dist/linkdeep_linux64 dist/linkdeep_linux32 dist/linkdeep_win64.exe dist/linkdeep_win32.exe dist/linkdeep_macos
...
dist/linkdeep_win64.exe: $(source)
	CGO_ENABLED=0 GOOS=windows GOARCH=amd64 go build -o dist/linkdeep_win64.exe

dist/linkdeep_win32.exe: $(source)
	CGO_ENABLED=0 GOOS=windows GOARCH=386 go build -o dist/linkdeep_win32.exe
